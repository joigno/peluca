...
function App() {
  ...
  return (
   ...
   &nbsp;
     ...
     La gran criptomoneda libertaria, militante y popular<Button color="inherit">  </Button>
         ...
         <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
         Circulante Máximo: { data.nextSupplyTarget } PELUCA
     ...
     <Button variant="outlined" style={{backgroundColor:'white',width:400}}  onClick={mint}  >RECLAMAR AIRDROP BÁSICO</Button>&nbsp;6 PELUCA&nbsp;{  data.dropDisabled } <br></br><br></br>
     ...
     <TextField id="outlined-basic" label="Dirección BSC" variant="outlined" style={{backgroundColor:'white',width:400,borderRadius:10,marginRight:80 }}     onChange={e => setAmigoAddress(e.target.value)} /><br></br><br></br>
   ...
   <iframe src="https://app.bogged.finance/swap?tokenIn=0xe9e7cea3dedca5984780bafc599bd69add087d56&tokenOut=0x353395eB36E03Fe72Dce4EE77558688969283F91&embed=1&slippage=4" height="850px" width="100%" ></iframe>
     ...
     <CardContent>
       ...
       ¿Cual es la emisón máxima de la criptomoneda $PELUCA? 
       </Typography>
       <br></br>
   ...
   <Card style={{width:500,margin:20}}>
     <CardContent>
       ...
       <Typography variant="h5" component="div">
       ¿Como es el Tokenomics/Emisión de la criptomoneda $PELUCA?
       </Typography>
       <br></br>
       <Typography sx={{ mb: 1.5 }} color="text.secondary">
  ...
  precio continuará flotando libremente, ahora con mayor libertad sin depender del precio de los drops/regalos.
       </Typography>
...
<div style={{display:'flex',textAlign:'center',justifyContent:'center'}}>
  ...
  el <a href="https://bscscan.com/token/0x353395eB36E03Fe72Dce4EE77558688969283F91">explorador BscScan</a> con la dirección del token (<a href="https://bscscan.com/token/0x353395eB36E03Fe72Dce4EE77558688969283F91">0x353395eB36E03Fe72Dce4EE77558688969283F91</a>). 
       </Typography>
   ...
   <Card style={{width:500,margin:20}}>
     <CardContent>
       ...
       <Typography variant="h5" component="div">
       ¿Cual es el código fuente de $PELUCA?
       </Typography>
       <br></br>
       <Typography sx={{ mb: 1.5 }} color="text.secondary">
       El código de fuente de Peluca es
  ...
  correcto de la criptomoneda. El equipo desarrollador se dedica a la auditoría y desarrollo de criptotokens y aplicaciones de finanzas descentralizadas.
       </Typography>
